...
with open("./checkpoints/biencoder/embeddings/embeddings.json_0.pkl", "rb") as f:
    embeddings = pickle.load(f)

dpr = models.setup_closedbook(0)
print(type(dpr.retriever.index))
...
## Actor = GPT MODEL
## State = tensor number of steps so far, length of current thing, correct length of answer, original clue, current version
## reward = function of current version of clue and correct answer vs prev state, penalties for length not being matched, penalties for taking too many steps
## 